// src/pages/membredirection/MembreDirectionParametres.jsx
...
export default function MembreDirectionParametres() {
  ...
  // Charger les données du membre de direction au chargement du composant
  useEffect(() => {
  ...
  const handlePasswordSubmit = async (e) => {
    ...
    try {
      await membreDirectionAPI.updatePassword(
  ...
  const handleEditSubmit = async (field) => {
    try {
      ...
      await membreDirectionAPI.updateMembreInfo(updateData);
      ...
      setUpdateError(typeof err === 'string' ? err : `Impossible de mettre à jour le ${field === 'email' ? 'email' : 'téléphone'}`);
    }
  };
  ...
  return (
    <MembreDirectionLayout defaultActivePage="parametres">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="flex justify-between items-center">
          <button 
            ...
            onClick={() => navigate('/membredirection/accueil')}
          >
